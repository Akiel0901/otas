...
<body class="hold-transition ">
  ...
  <style>
    ...
    .bg-faded-black {
    background: rgba(100, 0, 0, 0.6); /* Adjust the alpha value (0.6) to control the level of transparency */
}
  </style>
...
<div class="h-100 d-flex  align-items-center w-100" id="login">
    <div class="col-7 h-100 d-flex align-items-center justify-content-center">
      <div class="w-100">
        ...
        <h1 class="text-center py-2 login-title"><b><?php echo $_settings->info('name') ?></b></h1>
      </div>
      
    </div>
    <div class="col-5 h-100 bg-gradient bg-faded-black">
        <div class="w-100 d-flex justify-content-center align-items-center h-100 text-navy">
            <div class="card card-outline card-danger rounded-1 shadow col-lg-10 col-md-10 col-sm-5">
                ...
                <div class="card-body">
                    <form action="" id="slogin-form">
                        ...
                        <div class="row">
                        <div class="col-8">
                  <a href="<?php echo base_url ?>"style="color: red;">Go Back</a>
                </div>
                            <div class="col-4">
                                <div class="form-group text-right">
                                    <button class="btn btn-default bg-danger btn-flat"> Login</button>
                                </div>
                            </div>
                        </div>
                    </form>
