...
<!-- Navbar -->
      ...
      background-color: rgb(100,0,0);/* Replace with your desired background color */
      padding: 5px;
    }
      </style>
      <nav class="bg-faded-black w-100 px-2 py-1 position-fixed top-0" id="login-nav">
        <div class="d-flex justify-content-between w-100">
          <div>
            <span class="mr-2  text-warning" style="font-size: 20px; font-weight: bold; font-color: #FFD700;"> <?= $_settings->info('contact') ?></span>
          </div>
          <div>
            ...
            <?php else: ?>
              <a href="./register.php" class="mx-2 text-light me-2 hover-bg-color">Register</a>
              <a href="./login.php" class="mx-2 text-light me-2 hover-bg-color">Student Login</a>
              <a href="./admin" class="mx-2 text-light hover-bg-color">Admin login</a>
            <?php endif; ?>
          </div>
        </div>
      </nav>
