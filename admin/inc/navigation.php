<style>
.nav.nav-sidebar li.nav-item a.nav-link {
    color: white;
  }
</style>
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-secondary elevation-4 sidebar-no-expand"style="background-color: #8B0000;">
        <!-- Brand Logo -->
        ...
        <span class="brand-text font-weight-light"style="font-size:22px;"><?php echo $_settings->info('short_name') ?></span>
        </a>
        <!-- Sidebar -->
          ...
          <div class="os-padding">
            <div class="os-viewport os-viewport-native-scrollbars-invisible" style="overflow-y: scroll;">
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <!-- Sidebar Menu -->
                <nav class="mt-5">
                   <ul class="nav nav-pills nav-sidebar flex-column text-m nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=visualization" class="nav-link nav-user_list">
