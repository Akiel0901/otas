				...
				<tbody>
					...
					?>
						<tr>
							...
							<td align="center">
                                <a class="btn btn-flat btn-default btn-sm view_data" href="javascript:void(0)" data-id ="<?php echo $row['id'] ?>"><span class="fa fa-eye text-black"></span></a>
                                <a class="btn btn-flat btn-default btn-sm edit_data" href="javascript:void(0)" data-id ="<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span></a>
                                <a class="btn btn-flat btn-default btn-sm delete_data" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"><span class="fa fa-trash text-danger"></span></a>
							</td>
						</tr>
					<?php endwhile; ?>
				</tbody>
