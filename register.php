...
<body class="hold-transition ">
  ...
  <style>
    ...
    .bg-faded-black {
    background: rgba(150, 0, 0, 0.6); /* Adjust the alpha value (0.6) to control the level of transparency */
}
  </style>
<div class="h-100 d-flex  align-items-center w-100" id="login">
    ...
    <div class="col-5 h-100 bg-gradient bg-faded-black">
        <div class="w-100 d-flex justify-content-center align-items-center h-100 text-navy">
            <div class="card card-outline card-danger rounded-0 shadow col-lg-10 col-md-10 col-sm-5">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group text-right">
                                    <button class="btn btn-default bg-danger btn-flat"> Register</button>
                                </div>
                            </div>
                        </div>
                    </form>
